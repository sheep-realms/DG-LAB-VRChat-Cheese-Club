...
class OSCPanel(ctk.CTkFrame):
    ...
    def _build_ui(self):
        ...
        self._connect_btn = ctk.CTkButton(
            btn_frame, text="连接", font=ctk.CTkFont(family="MiSans Normal", size=15, weight="bold"),
        ...
        self._disconnect_btn = ctk.CTkButton(
            btn_frame, text="断开", font=ctk.CTkFont(family="MiSans Normal", size=15, weight="bold"),
